...
(function() {
    ...
    function updateMenu() {
        var elements = document.getElementById('topnav-menu-content')
        if (elements) elements = elements.getElementsByTagName('a');
        else return
        for (var i = 0, len = elements.length; i < len; i++) {
    ...
    function layoutSetting() {
        ...
        var rightToggle = document.getElementById('right-bar-toggle')
        ...
        body.hasAttribute('data-layout-scrollable') && body.getAttribute('data-layout-scrollable') == 'true' ?
